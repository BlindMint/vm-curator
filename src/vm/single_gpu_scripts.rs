...
# Generated by VM Foundry for: {vm_name}
#
...
if ! modinfo vfio_pci &>/dev/null; then
    ...
    echo "Run System Setup from VM Foundry Settings > Single GPU Passthrough"
    exit 1
fi
{tpm_functions}
# ============================================================================
...
pub fn run_system_setup(gpu_driver: &str) -> SystemSetupResult {
    ...
    let script_path = "/tmp/vm-foundry-vfio-setup.sh";
